...
class CurveViewSettings(context: Context, attrs: AttributeSet?) {
    ...
    init {
        ...
        arcWidth = styledAttributes.getDimension(R.styleable.ArcDrawer_curveWidth, dpToPx(context, 10))

        val cropDirection = styledAttributes.getInt(R.styleable.ArcDrawer_curveCropDirection, CROP_INSIDE)
